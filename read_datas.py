...
def read_data():
    ...
    text = []
    labels = []
    data_df = pd.read_csv("five_star_movie_reviews.tsv",sep="\t", names=["PhraseId","SentenceId","Phrase","Sentiment"],low_memory=False) #Column 1: any texts, column 2: any binary labels
